  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#2a221b] dark:text-[#f5f0eb]">
            Relatórios
          </h1>
          <p className="mt-1 text-sm text-[#8c7f74] dark:text-[#8a7f75]">
            Transforme os dados da operação em informações para tomada de decisão.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#235347] hover:bg-[#1b4339] text-white text-xs font-medium shadow-xs hover:shadow-sm transition-all active:scale-95"
